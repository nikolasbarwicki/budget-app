...
// Initial state
const initialState = {
  income: [1300, 1400, 1350, 1500, 1450],
  expense: [950, 1170, 895, 805, 970],
  budget: [
    [],
    [],
    [],
  ...
  expenses: [
    [{ id: 1, name: 'Apartment', category: 'Rent', date: '2020-01-01', amount: 950 }],
    [{ id: 1, name: 'Apartment', category: 'Rent', date: '2020-02-01', amount: 1170 }],
    [{ id: 1, name: 'Apartment', category: 'Rent', date: '2020-03-01', amount: 895 }],
    [{ id: 1, name: 'Apartment', category: 'Rent', date: '2020-04-01', amount: 1050 }],
    [
      { id: 1, name: 'Apartment', category: 'Rent', date: '2020-05-01', amount: 180 },
      { id: 2, name: 'Shoes', category: 'Clothes', date: '2020-05-02', amount: 100 },
      { id: 3, name: 'Suit', category: 'Clothes', date: '2020-05-03', amount: 70 },
      { id: 4, name: 'Tesco', category: 'Food', date: '2020-05-04', amount: 85 },
